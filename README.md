...
# 生成200个题目， 生成整十的减法(-c _0指定)，数据范围是[80,99]
gen_arithmatic add-minus -n 200 -c _0 -l 80 -r 99

# 生成200个题目， 生成减法(-c _指定)，数据范围是[80,99]
gen_arithmatic add-minus -n 200 -c _ -l 80 -r 99
